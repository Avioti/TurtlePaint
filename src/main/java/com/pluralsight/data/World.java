 ...
 * Usage example:
 * <pre>
 * com.pluralsight.data.World basic = new com.pluralsight.data.World();
 * com.pluralsight.data.World fancy = new com.pluralsight.data.World(640, 480, Color.YELLOW);
 *
 * com.pluralsight.data.Turtle t1 = new com.pluralsight.data.Turtle(basic);
 * com.pluralsight.data.Turtle t2 = new com.pluralsight.data.Turtle(fancy);
 *
 * t1.forward(100);
 * basic.erase();
 * t1.turnLeft(90);
...
public class World extends JFrame {
    ...
    /**
     * Creates a new com.pluralsight.data.World for Turtles to play in.
     */
    public World() {
        this(600, 600);
    }
    ...
    public World(int width, int height, Color backgroundColor) {
        super("com.pluralsight.data.Turtle com.pluralsight.data.World");
    ...
    /**
     * Should only called by the com.pluralsight.data.Turtle class constructor
     */
    ...
    /**
     * Should only called by com.pluralsight.data.Turtle class methods
     */
    ...
    /**
     * To be used by com.pluralsight.data.Turtle class only
