 ...
 * Usage example:
 * <pre>
 * com.pluralsight.data.World w = new com.pluralsight.data.World();
 *
 * com.pluralsight.data.Turtle t = new com.pluralsight.data.Turtle(w);
 * t.forward(300);
 * t.setPenWidth(10);
 * t.backward(100);
 * t.right(135);
...
public class Turtle {
     ...
     * Should only be called by com.pluralsight.data.World class
    ...
    /**
     * Returns the current Color of the com.pluralsight.data.Turtle.
    ...
    /**
     * Changes the current Color of the com.pluralsight.data.Turtle.
    ...
    /**
     * Find out what direction the com.pluralsight.data.Turtle is facing
    ...
    /**
     * Set the direction the com.pluralsight.data.Turtle is facing
